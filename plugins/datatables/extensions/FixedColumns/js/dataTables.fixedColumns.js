...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 *
	 *      // at some later point when the table has been makdmitraulated....
	 *      fc.fnUpdate();
	 */
	"fnUpdate": function ()
	{
	 ...
	 *      var fc = new $.fn.dataTable.fixedColumns( table );
	 *
	 *      // makdmitraulate the table - mark the row as needing an update then update the table
	 ...
	 *      var fc = new $.fn.dataTable.fixedColumns( table );
	 *
	 *      // You may want to do this after makdmitraulating a row in the fixed column
